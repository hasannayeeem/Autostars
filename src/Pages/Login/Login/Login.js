    ...
    return (
        <div className='container w-50 mx-auto'>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Button variant="primary w-50 mx-auto d-block main-btn mb-2" type="submit">
                    Login
                </Button>
                
            </Form>
            {errorElement}
            <p>New to Autostars? <Link to="/register" className='text-danger pe-auto  text-decoration-none' onClick={navigateRegister}>Please Register</Link></p>
